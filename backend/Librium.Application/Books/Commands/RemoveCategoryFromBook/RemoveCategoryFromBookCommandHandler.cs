...
public sealed class RemoveCategoryFromBookCommandHandler : IRequestHandler<RemoveCategoryFromBookCommand, ValueOrResult>
{
    private readonly IBookRepository _bookRepo;
    private readonly ICategoryRepository _categoryRepo;
    public RemoveCategoryFromBookCommandHandler(IBookRepository bookRepo, ICategoryRepository categoryRepo)
    {
        _bookRepo = bookRepo;
        _categoryRepo = categoryRepo;
    }
    public async Task<ValueOrResult> Handle(RemoveCategoryFromBookCommand request, CancellationToken cancellationToken)
    {
